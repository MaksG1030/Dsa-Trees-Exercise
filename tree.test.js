...
//  New test to account for my .values() getter
beforeEach(function () {
    emptyTree = new Tree();
    
    // build small tree
    let nSmall2 = new TreeNode(2);
    let nSmall = new TreeNode(1, [nSmall2]);
    smallTree = new Tree(nSmall);
    
    // build large tree
    let n8 = new TreeNode(8);
    let n7 = new TreeNode(7, [n8]);
    let n6 = new TreeNode(6, [n7]);
    let n5 = new TreeNode(5);
    let n4 = new TreeNode(4, [n5, n6]);
    let n3 = new TreeNode(3);
    let n2 = new TreeNode(2);
    let n = new TreeNode(1, [n2, n3, n4]);
